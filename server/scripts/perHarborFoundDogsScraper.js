...
nightmare
  ...
  .evaluate(function () {
    ...
    allImages = allImages.map(elem => 'http://petharbor.com/get_image.asp?RES=Detail&' + elem.slice(elem.indexOf('?') + 1, elem.indexOf('&searchtype')))
    ...
    for (let i = 0; i < allDates.length; i++) {
      ...
      else if (allAddresses[i].includes("City of Georgetown Animal Shelter")) zip = "78626";
      else if (allAddresses[i].includes("City of Killeen Animal Services Unit")) zip = "76543";
