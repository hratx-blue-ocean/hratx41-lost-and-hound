...
nightmare
  ...
  .evaluate(function () {
    ...
    resultArray = resultArray.filter(dogObj => {
      return (dogObj.location.city !== undefined && (dogObj.location.city.toLowerCase() === "austin" || dogObj.location.city.toLowerCase() === "georgetown" || dogObj.location.city.toLowerCase() === "killeen" || dogObj.location.city.toLowerCase() === "harker heights" || dogObj.location.city.toLowerCase() === "pflugerville"))
    })
    return resultArray;
  })
